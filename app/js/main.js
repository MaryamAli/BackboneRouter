...
var DetailModel = _backbone2['default'].Model.extend({
...
var _detailModel = require('./detailModel');

var _detailModel2 = _interopRequireDefault(_detailModel);

var detailsCollection = _backbone2['default'].Collection.extend({

  url: 'https://api.parse.com/1/classes/MyPeeps',

  model: _detailModel2['default'],
...
exports['default'] = detailsCollection;
module.exports = exports['default'];

},{"./detailModel":2,"backbone":8}],4:[function(require,module,exports){
'use strict';
...
var _detailsCollection = require('./detailsCollection');

var _detailsCollection2 = _interopRequireDefault(_detailsCollection);
...
},{"./ajaxSetup":1,"./detailsCollection":3,"./router":5,"jquery":9,"moment":10,"underscore":11}],5:[function(require,module,exports){
'use strict';
...
var _viewsDetails2 = _interopRequireDefault(_viewsDetails);
...
var Router = _backbone2['default'].Router.extend({
  ...
  initialize: function initialize(appElement) {
    ...
    this.$el = appElement;
    this.details = new _detailsCollection2['default']();
  ...
  list: function list() {
    ...
    this.details.fetch().then((function () {
      ...
      this.$el.html((0, _viewsList2['default'])(this.details.toJSON));
    }).bind(this));
  },
  ...
  showSpecificDetail: function showSpecificDetail(detailId) {
    var _this = this;
    ...
    if (detail) {
      ...
      (function () {
        ...
        var detail = _this.details.add({ objectId: todoId });
        router = _this;
...
},{"./detailsCollection":3,"./views/details":6,"./views/list":7,"backbone":8,"jquery":9}],6:[function(require,module,exports){
'use strict';
...
// class='contact-list-item' data-contact-id="${item.objectId}"
module.exports = exports['default'];
